...
export type AudienceMode = 'GROUP' | 'CSV' | 'FILTER'; 
export type ScheduleMode = 'SEND_NOW' | 'SCHEDULED'; 
export type SystemVariable = 'today' | 'tomorrow' | 'now_time' | 'sender_display_name' | 'unsubscribe_url'; 
export type VariableSource = { kind: 'contact_field'; field: string; fallback?: string } | { kind: 'literal'; value: string } | { kind: 'system'; name: SystemVariable } | { kind: 'campaign_field'; field: string }; 
