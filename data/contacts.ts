...
let contacts: Contact[] = [
  {
    id: "contact-1", firstName: "Sarah", lastName: "Johnson", phone: "+14155550101",
    countryCode: "US", email: "sarah.j@email.com", tags: ["vip", "returning"],
  ...
  {
    id: "contact-2", firstName: "Marcus", lastName: "Williams", phone: "+14155550102",
    countryCode: "US", email: "marcus.w@email.com", tags: ["returning"],
  ...
  {
    id: "contact-3", firstName: "Priya", lastName: "Sharma", phone: "+919876543210",
    countryCode: "IN", email: "priya.s@email.com", tags: ["new", "marketing"],
  ...
  {
    id: "contact-4", firstName: "James", lastName: "O'Brien", phone: "+447700900123",
    countryCode: "GB", email: "james.ob@email.com", tags: ["vip"],
  ...
  {
    id: "contact-5", firstName: "Ana", lastName: "Lima", phone: "+5511987654321",
    countryCode: "BR", email: "ana.lima@email.com.br", tags: ["brazil", "new"],
  ...
  {
    id: "contact-6", firstName: "David", lastName: "Chen", phone: "+6598765432",
    countryCode: "SG", email: "david.c@email.sg", tags: ["enterprise"],
  ...
  {
    id: "contact-7", firstName: "Maria", lastName: "Garcia", phone: "+34612345678",
    countryCode: "ES", email: "maria.g@email.es", tags: ["spain", "returning"],
  ...
  {
    id: "contact-8", firstName: "Kwame", lastName: "Asante", phone: "+233244123456",
    countryCode: "GH", tags: ["new"],
...
let optInRecords: OptInRecord[] = [
  { id: "opt-1", contactId: "contact-1", contactName: "Sarah Johnson", phone: "+14155550101", method: "web_form", sourceUrl: "https://acmecorp.com/signup", timestamp: "2024-01-15T10:00:00Z", ipAddress: "192.168.1.1", status: "opted_in" },
  { id: "opt-2", contactId: "contact-2", contactName: "Marcus Williams", phone: "+14155550102", method: "conversation_reply", timestamp: "2024-02-20T14:00:00Z", status: "opted_in" },
  { id: "opt-3", contactId: "contact-3", contactName: "Priya Sharma", phone: "+919876543210", method: "imported", timestamp: "2025-03-01T08:00:00Z", status: "opted_in" },
  { id: "opt-4", contactId: "contact-4", contactName: "James O'Brien", phone: "+447700900123", method: "web_form", sourceUrl: "https://acmecorp.co.uk/signup", timestamp: "2024-03-10T11:00:00Z", ipAddress: "10.0.0.5", status: "opted_in" },
  { id: "opt-5", contactId: "contact-7", contactName: "Maria Garcia", phone: "+34612345678", method: "web_form", sourceUrl: "https://acmecorp.es/signup", timestamp: "2024-01-30T10:00:00Z", ipAddress: "172.16.0.1", status: "opted_out" },
  { id: "opt-6", contactId: "contact-8", contactName: "Kwame Asante", phone: "+233244123456", method: "ivr", timestamp: "2025-02-14T08:00:00Z", status: "opted_in" },
];
